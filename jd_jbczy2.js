...
[task_local]
#金榜创造营
13 1,22 * * * https://jdsharedresourcescdn.azureedge.net/jdresource/jd_gold_creator.js, tag=金榜创造营, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
...
====================Surge================
金榜创造营 = type=cron,cronexp="13 1,22 * * *",wake-system=1,timeout=3600,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_gold_creator.js

============小火箭=========
金榜创造营 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_gold_creator.js, cronexpr="13 1,22 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜创造营');
