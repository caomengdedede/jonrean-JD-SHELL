...
const inviteCodes = [
  'naQS-iAjw9ac7e-PRKDUyA==@Y3_YsPUMWIAcGYoKsCM3Qg==@DyWgQWFx_BA7Rf-RBS4I8g==@Q3NUNxeXsZ29PArM5PGlqQ=='
];
...
function updateTuanIdsCDN(url = 'https://gitee.com/Soundantony/updateTeam/raw/master/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    $.get({url,
      timeout: 200000,
      headers:{
