...
更新地址：https://raw.githubusercontent.com/jackpater/MyActions/main/scripts/jd_ds.js
...
[task_local]
#京东代属
10 7 * * * https://raw.githubusercontent.com/jackpater/MyActions/main/scripts/jd_ds.js, tag=京东代属, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_ds.png, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=https://raw.githubusercontent.com/jackpater/MyActions/main/scripts/jd_ds.js, tag=京东代属

===============Surge=================
京东代属 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/jackpater/MyActions/main/scripts/jd_ds.js

============小火箭=========
京东代属 = type=cron,script-path=https://raw.githubusercontent.com/jackpater/MyActions/main/scripts/jd_ds.js, cronexpr="10 7 * * *", timeout=200, enable=true
 */
const $ = new Env('京东代属');
...
function taskUrl(function_id, body = {}) {
  return {
    ...
    headers: {
      ...
      "Cookie": cookie,
      "User-Agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/7.0.18(0x17001231) NetType/WIFI Language/zh_CN'//$.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;iPhone;9.2.2;14.2;%E4%BA%AC%E4%B8%9C/9.2.2 CFNetwork/1206 Darwin/20.1.0"),
    }
  }
}
function TotalBean() {
